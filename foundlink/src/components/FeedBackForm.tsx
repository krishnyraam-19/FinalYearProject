  ...
  return (
    <div className="p-5 max-w-xl">
      ...
      <div className="border p-4 rounded mb-4">
        ...
        <p>
          <strong>Resolve Status:</strong> {item.resolveStatus}
        </p>
        <p>
        ...
        <p>
          <strong>Requester User ID:</strong> {requestUserId}
        </p>
        <p>
          <strong>Requester Name:</strong> {requestUser?.fname}{" "}
          {requestUser?.lname}
        </p>
        <p>
          <strong>Requester Email:</strong> {requestUser?.email}
        </p>
        <p>
          <strong>Requester Phone:</strong> {requestUser?.phone}
        </p>
      </div>
